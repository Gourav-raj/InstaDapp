...
class InputBox extends Component {
    ...
    return (
        <div className="bg-white p-2 rounded-2xl shadow-md text-gray-500 font-medium mt-6">
            <div className="flex space-x-1 p-3 items-center">
                <form 
                className="flex-1"
                onSubmit={(event) => {
                   ...
                   <input
                        ...
                        className="rounded-full h-10 bg-gray-100 flex-grow px-4 focus:outline-none"
                        placeholder="Add a Caption!!"
                        required />
                    
                <div className="block md:flex my-4 mx-4">
                ...
                />
                <button type="submit" className="bg-blue-400 rounded text-white p-1 hover:bg-red-700 ">Upload!</button>
                </div>
              </form>
